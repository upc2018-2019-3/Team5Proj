...
img{border:none;}
*{font-family:'微软雅黑';font-size:12px;cwolor:#626262;}
...
<div class="container">
	...
	<div class="leftsidebar_box">
		...
		<dl class="system_log">
			<dt onClick="changeImage()">个人信息管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="xueshengxinxi_updt2.jsp" target="rightFrame">个人信息修改</a></dd>
		</dl>
		
		<dl class="system_log">
			<dt onClick="changeImage()">选课信息<img src="images/left/select_xl01.png"></dt>
			<dd><a href="youjian_list3.jsp" target="rightFrame">查看选课信息</a></dd>
		</dl>
	
			<dl class="custom">
			<dt onClick="changeImage()">学生缴费<img src="images/left/select_xl01.png"></dt>
			<dd><a href="jiaofei_list2.jsp" target="rightFrame">缴费查询</a></dd>
		</dl>
			<dl class="app">
			<dt onClick="changeImage()">公告信息<img src="images/left/select_xl01.png"></dt>
            <dd><a href="youjian_list.jsp" target="rightFrame">查看公告</a></dd>
