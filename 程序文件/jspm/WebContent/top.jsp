    ...
    <td valign="top" ><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="301"><table width="100%" align="center" height="34" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><div style="font-family:宋体; color:#FFFFFF;  WIDTH: 100%; FONT-WEIGHT: bold; FONT-SIZE: 19pt; margin-top:5pt">
                <div align="center">学分制学费管理系统</div>
            </div></td>
          </tr>
        </table></td>
        ...
        <td width="1098"  align="right"><table width="100%" height="85" border="0">
          ...
          <tr>
            <td align="right"><font color="#FFFFFF" style="font-size:12px">当前用户：<%=request.getSession().getAttribute("username")%>&nbsp;&nbsp;身份：<%=request.getSession().getAttribute("cx")%>&nbsp;&nbsp;&nbsp;&nbsp;</font><a href="logout.jsp" target="_parent"><font color="#FFFFFF">退出</font></a></td>
          </tr>
        </table></td>
      </tr>
    </table> </td>
